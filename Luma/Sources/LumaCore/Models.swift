...
public struct NightSettings: Codable, Equatable, Sendable {
  ...
  public func validated() -> NightSettings {
    var value = self
    value.intervalSeconds = [3, 8, 12].contains(intervalSeconds) ? intervalSeconds : 12
...
public struct DreamEntry: Codable, Equatable, Identifiable, Sendable {
  ...
  public var hasContent: Bool { !text.trimmingCharacters(in: .whitespacesAndNewlines).isEmpty || !(voiceNotes ?? []).isEmpty }
