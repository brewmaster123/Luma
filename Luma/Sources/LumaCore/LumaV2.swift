...
public struct LumaState: Codable, Sendable {
  ...
  /// Preserve the Codable schema, IDs, audio and journal when updating v0.3/0.4.
  public mutating func useNotificationDelivery() {
    defaultPhoneDelivery = .shortCue
    for i in alarms.indices { alarms[i].phoneDelivery = .shortCue }
  }
